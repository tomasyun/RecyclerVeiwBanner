package cn.yunt.www.recyclerviewbannerdemo.widget;
...
import cn.yunt.www.recyclerviewbannerdemo.R;
...
public class RVBanner extends FrameLayout {
    ...
    public RVBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RVBanner(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        size = (int) (5 * context.getResources().getDisplayMetrics().density + 0.5f);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RVBanner);
        isShowPoint = typedArray.getBoolean(R.styleable.RVBanner_isShowPoint, true);
        pointFocusBg = typedArray.getColor(R.styleable.RVBanner_pointFocusBg, 0xff0099ff);
        pointUnFocusBg = typedArray.getColor(R.styleable.RVBanner_pointUnfocusBg, 0xffffffff);
        millisecond = typedArray.getInt(R.styleable.RVBanner_interval, 3000);
        typedArray.recycle();
