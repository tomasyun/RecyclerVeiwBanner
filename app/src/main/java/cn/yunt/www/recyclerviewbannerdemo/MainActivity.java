package cn.yunt.www.recyclerviewbannerdemo;
...
import cn.yunt.www.recyclerviewbannerdemo.widget.RVBanner;

public class MainActivity extends AppCompatActivity {
    private RVBanner rvBanner;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        rvBanner = (RVBanner) findViewById(R.id.rv_banner);
        ...
        rvBanner.isShowIndicatorPoint(true);
        rvBanner.setRvBannerDatas(banners);
        rvBanner.setOnSwitchRvBannerListener(new RVBanner.OnSwitchRvBannerListener() {
            @Override
